angular.module( 'app.reportParamsObjects', [
  'ui.router',
  'ui.bootstrap'
])

.config(function config( $stateProvider ) {
  $stateProvider.state( 'reportParamsObjects', {
    url: '/reportParamsObjects',
    views: {
      "main": {
        controller: 'ReportParamsObjectsCtrl',
        templateUrl: 'scripts/modules/reportParamsObjects/reportParamsObjects.tpl.html'
      }
    },
    data:{ pageTitle: 'Report Params Objects' }
  });
})

.controller( 'ReportParamsObjectsCtrl', function ReportParamsObjectsCtrl( $scope, dataServices,$http,$timeout) {
